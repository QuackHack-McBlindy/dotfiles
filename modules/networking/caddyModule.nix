...
let
  cfg = config.services.caddy-duckdns;
...
in
{
  ...
  # interface
  options.services.caddy-duckdns = {
  ...
  config = mkIf cfg.enable {
    ...
    services.caddy-duckdns.globalConfig = ''
    ...
    systemd.services.caddy = {
      ...
      serviceConfig =
        ...
        in
        {
          ...
          ExecStart = [
            ""
            ''./bin/caddy run ${runOptions} ${optionalString cfg.resume "--resume"}''
          ];
