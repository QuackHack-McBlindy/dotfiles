...
#  keybindingsPath = "/home/pungkula/dotfiles/home-manager/modules/keybindings/${hostname}.nix";
in

  
{
    # Now use `hostname` as needed, e.g., setting a custom environment variable
  #  environment.variables.HOSTNAME = hostname;

   # imports = [
   #     keybindingsPath+
   #     #"/home/pungkula/dotfiles/home-manager/modules/keybindings/${hostname}.nix"
   # ];
...
#°✶.•°•.•°•.•°•.✶°°✶.•°•.•°•.•°•.✶°°✶.•°•.•°•.•°•.✶°°✶.•°•.•°•.•°•.✶°°✶.•°•.•°•.•°•.✶°°✶.•°•.•°•.•°•.✶°
    ...
    # Fav Apps
        "org/gnome/shell".favorite-apps = ["org.gnome.Nautilus.desktop" "firefox.desktop" "org.gnome.TextEditor.desktop" "org.gnome.Terminal.desktop" "vesktop.desktop" "keepass.desktop"];
    # Terminal Profile
     ...
     # Open Bar
        "org/gnome/shell/extensions/openbar" = {
          ...
          # "org/gnome/shell/extensions/openbar".bguri = "file:///home/pungkula/.config/background.png";
            ...
            count8 = "20658";
            count9 = "11091";
        #    "org/gnome/shell/extensions/openbar".dark-bguri = "file:///home/pungkula/.config/background.png";
        ...
        #    "org/gnome/shell/extensions/openbar".light-bguri = "file:///home/pungkula/.config/background.png";
...
#°✶.•°•.•°•.•°•.✶°°✶.•°•.•°•.•°•.✶°°✶.•°•.•°•.•°•.✶°°✶.•°•.•°•.•°•.✶°°✶.•°•.•°•.•°•.✶°°✶.•°•.•°•.•°•.✶°
    # Keyboard Repeat  
        "org/gnome/desktop/peripherals/keyboard" = {
            repeat = true;
            delay = 5000; # initial delay before repeat
            repeat-interval = 15;
        };  
    # Mouse
        "org/gnome/desktop/peripherals/mouse".speed = "-0/1171875";
