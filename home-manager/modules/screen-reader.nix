...

{
  ...
  home.file."speechd" = {
    source = "/home/pungkula/dotfiles/home/.config/speech-dispatcher/speechd.conf";
  ...
  home.file."piper-module" = {
    source = "/home/pungkula/dotfiles/home/.config/speech-dispatcher/modules/piper-tts-generic.conf";
...
#  }; 
  ...
  home.file."speech-dispatcher-desktop" = {
    source = "/home/pungkula/dotfiles/home/.config/speech-dispatcher/desktop/speechd.desktop";
  ...
  home.file."orca-user-settings" = {
    source = "/home/pungkula/dotfiles/home/.local/share/orca/user-settings.conf";
