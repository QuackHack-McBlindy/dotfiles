...
EOF
    ...
    code = ''
      ...
      #mqtt_pub -t "zigduck/crypto/xmr/price" -m "{\"current_price\": $XMR_PRICE, \"24h_change\": $XMR_24H, \"7d_change\": $XMR_7D}"
      FORMATTED_24H=$(printf "%.1f" "$XMR_24H")
      FORMATTED_7D=$(printf "%.1f" "$XMR_7D")
      mqtt_pub -t "zigduck/crypto/xmr/price" -m "{\"current_price\": $XMR_PRICE, \"24h_change\": $FORMATTED_24H, \"7d_change\": $FORMATTED_7D}"
