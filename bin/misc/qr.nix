...
#      aliases = [ "" ];
      parameters = [
        { 
          name = "input"; 
          description = "Data to encode into the QR code"; 
          optional = false; # Always required prameters first
        }
        { 
          name = "icon"; 
          description = "Fun icon for the QR code"; 
          default = "https://raw.githubusercontent.com/QuackHack-McBlindy/dotfiles/refs/heads/main/modules/themes/icons/duck2.png";
        }        
        { 
          name = "output"; 
          description = "Filename for the output PNG file"; 
          default = "./qr.png"; # Always required prameters first
        }
