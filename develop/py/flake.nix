    ...
    let
      ...
      SCRIPTCONTENT =
        ...
        CORRECTIONS = {
            ...
            "löven 1": "sport 1",
            "löven 2": "sport 2",                                                                     "löven 3": "sport 3",
            "löven 4": "sport 4",
            "löven 5": "tv4 hockey",
        ...
        #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
            ...
            if result.returncode != 0:                                                                    logging.error(f"Failed to connect to {device_ip}: {result.stderr.strip()}")
                return None
            return result.stdout.strip()                                                          #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
        def adb_disconnect(device_ip):
            command = f"adb disconnect {device_ip}"                                                   result = subprocess.run(command, shell=True, capture_output=True, text=True)
            if result.returncode != 0:
                logging.error(f"Failed to disconnect from {device_ip}: {result.stderr.strip()}")                                                                                                    return None
            return result.stdout.strip()
        #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
        def get_current_playing(ip_address):                                                          try:
