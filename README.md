...
```nix
{
  ...
  name = "gtk3.css";
  styles = "/nix/store/4a7wq78dm51faq4lns5b6g0gyp749xn4-source/modules/themes/css/gtk3.css"
};
```
<!-- THEME_END -->
...
View Flake Outputs
  ...
  <!-- TREE_START -->
```nix
git+file:///home/pungkula/dotfiles?ref=refs/heads/main&rev=da8b39ca3de002665c577550d751c6e3a0c69430
├───devShells
│   ├───aarch64-linux
