...
- 🗣️ **[NLP Module](https://github.com/QuackHack-McBlindy/dotfiles/blob/main/modules/programs/firefox.nix)** *(Dynamic regex with parameter resolution using Bash alone)* 
