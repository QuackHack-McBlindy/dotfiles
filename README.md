...
```nix
{
  ...
  name = "gtk3.css";
  styles = "/nix/store/w54ghwxglmbprbyjdy6ngqmxh0d96cpx-source/modules/themes/css/gtk3.css"
};
```
<!-- THEME_END -->
...
View Flake Outputs
  ...
  <!-- TREE_START -->
```nix
git+file:///home/pungkula/dotfiles?ref=refs/heads/main&rev=1a7f4fa2e1c2df243eb43f176ffe1d344cd05a10
├───devShells
│   ├───aarch64-linux
