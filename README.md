...
```nix
{
  ...
  name = "gtk3.css";
  styles = "/nix/store/7sl01mqlji7ax2yl2cqy7x77nmbfpj7i-source/modules/themes/css/gtk3.css"
};
```
<!-- THEME_END -->
...
View Flake Outputs
  ...
  <!-- TREE_START -->
```nix
git+file:///home/pungkula/dotfiles?ref=refs/heads/main&rev=5e99abfb1ef2fac3fded5a5be5492782e528fa03
├───devShells
│   ├───aarch64-linux
