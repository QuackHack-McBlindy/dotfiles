...
```nix
{
  ...
  name = "gtk3.css";
  styles = "/nix/store/wal4facdf5si207kq31l4sg31f0yjadi-source/modules/themes/css/gtk3.css"
};
```
<!-- THEME_END -->
...
View Flake Outputs
  ...
  <!-- TREE_START -->
```nix
git+file:///home/pungkula/dotfiles?ref=refs/heads/main&rev=a943fb7b30c1a5e5580c303473c9d63dcb7245cd
├───devShells
│   ├───aarch64-linux
