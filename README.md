...
```nix
{
  ...
  name = "gtk3.css";
  styles = "/nix/store/wxip4f6h6g13lkyfrs6p3h90h2jvpz4a-source/modules/themes/css/gtk3.css"
};
```
<!-- THEME_END -->
...
View Flake Outputs
  ...
  <!-- TREE_START -->
```nix
git+file:///home/pungkula/dotfiles?ref=refs/heads/main&rev=5ac3079cf209058c1d82f8b007de1632554ef0fa
├───devShells
│   ├───aarch64-linux
