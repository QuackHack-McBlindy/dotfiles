...
```nix
{
  ...
  name = "gtk3.css";
  styles = "/nix/store/r545gqnxkgqkbkappiaj28lwh5kpi256-source/modules/themes/css/gtk3.css"
};
```
<!-- THEME_END -->
...
View Flake Outputs
  ...
  <!-- TREE_START -->
```nix
git+file:///home/pungkula/dotfiles?ref=refs/heads/main&rev=33354ed5b92c25dffdd7c6db13b25b93eb73a35a
├───devShells
│   ├───aarch64-linux
