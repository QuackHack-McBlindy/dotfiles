...
<!-- SCRIPT_STATS_START -->
- __80 qwacktastic scripts in /bin - 46 scripts have voice commands.__ <br>
- __1876 dynamically generated regex patterns - makes 271861295 phrases available as commands.__ <br>
<!-- SCRIPT_STATS_END -->
...
```nix
{
  ...
  name = "gtk3.css";
  styles = "/nix/store/i810i99zil10dd8ahwxax81pj1091ik5-source/modules/themes/css/gtk3.css"
};
```
<!-- THEME_END -->
...
```nix
{
  arris = {
    ...
    channels = {
      1 = {
        cmd = "";
        icon = "/nix/store/i810i99zil10dd8ahwxax81pj1091ik5-source/modules/themes/icons/tv/1.png";
        id = 1;
        name = "SVT1";
      ...
      10 = {
        cmd = "";
        icon = "/nix/store/i810i99zil10dd8ahwxax81pj1091ik5-source/modules/themes/icons/tv/10.png";
        id = 10;
        name = "Kanal 10";
      ...
      11 = {
        cmd = "";
        icon = "/nix/store/i810i99zil10dd8ahwxax81pj1091ik5-source/modules/themes/icons/tv/11.png";
        id = 11;
        name = "Kanal 11";
      ...
      12 = {
        cmd = "";
        icon = "/nix/store/i810i99zil10dd8ahwxax81pj1091ik5-source/modules/themes/icons/tv/12.png";
        id = 12;
        name = "Kanal 12";
      ...
      13 = {
        ...
        icon = "/nix/store/i810i99zil10dd8ahwxax81pj1091ik5-source/modules/themes/icons/tv/13.png";
        id = 13;
        name = "TV4 Hockey";
      ...
      14 = {
        cmd = "nav_down && nav_down && nav_right && nav_right && nav_center";
        icon = "/nix/store/i810i99zil10dd8ahwxax81pj1091ik5-source/modules/themes/icons/tv/14.png";
        id = 14;
      ...
      15 = {
        cmd = "nav_down && nav_down && nav_right && nav_right && nav_center";
        icon = "/nix/store/i810i99zil10dd8ahwxax81pj1091ik5-source/modules/themes/icons/tv/15.png";
        id = 15;
      ...
      16 = {
        cmd = "nav_down && nav_down && nav_right && nav_right && nav_center";
        icon = "/nix/store/i810i99zil10dd8ahwxax81pj1091ik5-source/modules/themes/icons/tv/16.png";
        id = 16;
      ...
      17 = {
        cmd = "nav_down && nav_down && nav_right && nav_right && nav_center";
        icon = "/nix/store/i810i99zil10dd8ahwxax81pj1091ik5-source/modules/themes/icons/tv/17.png";
        id = 17;
      ...
      2 = {
        cmd = "";
        icon = "/nix/store/i810i99zil10dd8ahwxax81pj1091ik5-source/modules/themes/icons/tv/2.png";
        id = 2;
        name = "SVT2";
      ...
      3 = {
        cmd = "";
        icon = "/nix/store/i810i99zil10dd8ahwxax81pj1091ik5-source/modules/themes/icons/tv/3.png";
        id = 3;
        name = "Kanal 3";
      ...
      4 = {
        cmd = "";
        icon = "/nix/store/i810i99zil10dd8ahwxax81pj1091ik5-source/modules/themes/icons/tv/4.png";
        id = 4;
        name = "TV4";
      ...
      5 = {
        cmd = "";
        icon = "/nix/store/i810i99zil10dd8ahwxax81pj1091ik5-source/modules/themes/icons/tv/5.png";
        id = 5;
        name = "TV5";
      ...
      6 = {
        cmd = "";
        icon = "/nix/store/i810i99zil10dd8ahwxax81pj1091ik5-source/modules/themes/icons/tv/6.png";
        id = 6;
        name = "Kanal 6";
      ...
      7 = {
        cmd = "";
        icon = "/nix/store/i810i99zil10dd8ahwxax81pj1091ik5-source/modules/themes/icons/tv/7.png";
        id = 7;
        name = "Sjuan";
      ...
      8 = {
        cmd = "";
        icon = "/nix/store/i810i99zil10dd8ahwxax81pj1091ik5-source/modules/themes/icons/tv/8.png";
        id = 8;
        name = "TV8";
      ...
      9 = {
        cmd = "";
        icon = "/nix/store/i810i99zil10dd8ahwxax81pj1091ik5-source/modules/themes/icons/tv/9.png";
        id = 9;
        name = "Kanal 9";
...
| **🗣️ Voice** | | | |
| [yo do](https://github.com/QuackHack-McBlindy/dotfiles/blob/main/bin/voice/do.nix) --input [--fuzzy] [--dir] [--build] | d | Natural language to Shell script translator with dynamic regex matching and automatic parameter resolutiion. Written in Rust (Faster) | 📛 |
| [yo do-bash](https://github.com/QuackHack-McBlindy/dotfiles/blob/main/bin/voice/do-bash.nix) --input [--fuzzyThreshold] |  | [🦆🧠] yo do - The Brain of this repository. Natural language to Shell script translator with dynamic regex matching and automatic parameter resolutiion with some fuzzy on top of that. Written in Bash (slower, but more dope🦆, don't ya think?) | 📛 |
...
| [yo stats](https://github.com/QuackHack-McBlindy/dotfiles/blob/main/bin/voice/stats.nix) [--show] [--tail] [--reset] | stat | [🦆📶] duckStats - Statistical & metrics for the NLP (yo-do) module | 📛 |
...
| [yo house](https://github.com/QuackHack-McBlindy/dotfiles/blob/main/bin/home/house.nix) [--device] [--state] [--brightness] [--color] [--temperature] [--scene] [--user] [--passwordfile] [--flake] [--pair] [--cheapMode] |  | Control lights and other home automatioon devices | ✅ |
...
| [yo zigduck](https://github.com/QuackHack-McBlindy/dotfiles/blob/main/bin/home/zigduck.nix) [--user] [--pwfile] |  | Home automation system written in Bash | 📛 |
| [yo zigduck-rs](https://github.com/QuackHack-McBlindy/dotfiles/blob/main/bin/home/zigduck-rs.nix) [--dir] [--user] [--pwfile] |  | Home automation system written in Rust | 📛 |
| **🧩 Miscellaneous** | | | |
